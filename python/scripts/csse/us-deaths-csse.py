...
df = pd.read_csv(
    './data/COVID-19/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_US.csv')
...
col.insert_one({"index": "csse-all-us-deaths", "current_date": current_date, "data": data_dict})  # insert into DB
